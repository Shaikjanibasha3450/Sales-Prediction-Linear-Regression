...
axes[1].set_title(f'Testing Set: Actual vs Predicted (R² = {test_r2:.4f})',
                  fontsize=13, fontweight='bold')
...
print("""
1. MODEL PERFORMANCE:
   - Achieved R² Score of {:.4f} on testing data
   - RMSE of {:.2f} (very low error)
   - The model explains {:.2f}% of the variance in sales

2. FEATURE IMPORTANCE:
   - Radio advertising has the highest impact on sales (coeff: {:.4f})
   - TV advertising also significantly affects sales (coeff: {:.4f})
   - Newspaper advertising has minimal impact (coeff: {:.4f})
...
""".format(test_r2, test_rmse, test_r2*100, model.coef_[1], model.coef_[0], model.coef_[2]))
print("=" * 60)
